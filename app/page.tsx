  ...
  return (
    <>
      <style precedence="default" href="main-styles">{`
        ...
        header { padding: 20px 64px; border-bottom: 3px solid var(--navy); display: flex; justify-content: space-between; align-items: center; background: var(--cream); }
        .logo { display: flex; align-items: center; gap: 8px; text-decoration: none; }
        nav { display: flex; gap: 32px; align-items: center; }
        nav a { font-size: 0.8rem; font-weight: 500; letter-spacing: 0.06em; color: var(--navy); text-decoration: none; opacity: 0.65; transition: opacity 0.2s; }
        nav a:hover { opacity: 1; }
        .nav-cta { padding: 9px 22px; background: var(--red); color: var(--cream) !important; opacity: 1 !important; font-weight: 600 !important; box-shadow: 3px 3px 0 var(--navy); transition: all 0.15s !important; }
        ...
        footer { background: var(--navy); padding: 28px 64px; border-top: 4px solid var(--gold); display: flex; justify-content: space-between; align-items: center; }
      ...
      <header>
        <a href="/" className="logo">
          ...
          <span style={{fontFamily: "'Fraunces', serif", fontSize: "1.25rem", fontWeight: 700, color: "#0d2b45", letterSpacing: "-0.01em"}}>
